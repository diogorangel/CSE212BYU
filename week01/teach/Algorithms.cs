...
public static class Algorithms {
    public static void Run() {
        ...
        // Loop para testar o desempenho com tamanhos de entrada crescentes (n)
        for (int n = 0; n < 15001; n += 1000) {
            int count1 = Algorithm1(n);
            int count2 = Algorithm2(n);
            int count3 = Algorithm3(n);
            
            // Mede o tempo médio de execução em milissegundos (executando 10 vezes)
    ...
    /// <summary>
    /// Função utilitária para medir o tempo médio de execução de um algoritmo.
    /// </summary>
    ...
    /// <summary>
    /// Algorithm 2: O(n^2) - Laços aninhados
    /// </summary>
    ...
    /// <summary>
    /// Algorithm 3: O(log n) - Lógica de divisão pela metade (similar à busca binária)
    /// </summary>
    private static int Algorithm3(int size) {
        ...
        // O laço só continua se o espaço de busca for válido
        while (start <= end) {
            // Calcula o ponto médio
            var middle = (end - start) / 2 + start;
            
            // Simula o descarte de metade do espaço de busca
            start = middle + 1; 
